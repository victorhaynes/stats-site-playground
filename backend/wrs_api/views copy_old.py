...
def get_summoner_update(request):
    ...
    # Consider making entire function atomic
    # Also eventually fix Flex Queue
            ...
            if response_match_detail.status_code == 200 and timeline_response.status_code == 200:
                ...
                for participant_data in match_detail["info"]["participants"]:
                    ...
                    if len(participant_profile) == 0:
                        ...
                        print("Getting ESID from Riot API for:", participant_data["puuid"])
                        ...
                        if response_summonerID.status_code == 200:
                            ...
                            if response_overview.status_code == 200:
                                ...
                                return JsonResponse({"Riot API returned error": response_overview.status_code, "message": response_overview.json(), "meta": 288}, status=response_overview.status_code)
...
def test_all_matches(request):
    ...
    while True:
        ...
        if response_matches.status_code == 200:
            ...
            return JsonResponse({"Riot API returned error": response_matches.status_code, "message": response_matches.json(), "meta": 430}, status=response_matches.status_code)
