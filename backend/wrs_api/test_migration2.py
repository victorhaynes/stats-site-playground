### TOTALLY WORKING?
# Generated by Django 4.2.7 on 2024-03-29 18:15
        ...
        migrations.RunSQL(
            ...
            --- CHANGE id to SERIAL NOT NULL
                ...
                CREATE TABLE "wrs_api_summoner" (
                    ...
                    "created_at" timestamp with time zone NOT NULL,
                    "updated_at" timestamp with time zone NOT NULL,
                    "platform" varchar NOT NULL ON DELETE CASCADE,
                    PRIMARY KEY (platform, puuid)
                ) PARTITION BY LIST (platform);
...
# Generated by Django 4.2.7 on 2024-03-28 23:33
        ...
        migrations.RunSQL(
            ...
            ---partioned on platform
                CREATE TABLE "wrs_api_match" (
                    ...
                    "metadata" jsonb NOT NULL, 
                    PRIMARY KEY ("platform", "matchId"),
                    FOREIGN KEY ("queueId") REFERENCES wrs_api_gamemode ("queueId"),
                    FOREIGN KEY ("patch_id") REFERENCES wrs_api_patch ("full_version"),
                    FOREIGN KEY ("season_id") REFERENCES wrs_api_season ("id"),
                    FOREIGN KEY ("platform") REFERENCES "wrs_api_platform" ("code")
                ) PARTITION BY LIST ("platform");


                CREATE TABLE wrs_api_match_na1 PARTITION OF wrs_api_match FOR VALUES IN ('na1');
                CREATE TABLE wrs_api_match_euw1 PARTITION OF wrs_api_match FOR VALUES IN ('euw1');
                CREATE TABLE wrs_api_match_kr1 PARTITION OF wrs_api_match FOR VALUES IN ('br1');
