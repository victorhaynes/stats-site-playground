...
class ChampionStat(models.Model):    
    ...
    class Meta:
        unique_together = ["championId", "role", "elo", "platform", "patch"]
...
class RunePageStat(models.Model):
    ...
    class Meta:
        unique_together = ["keystone", "primary_one", "primary_two", "primary_three", "secondary_one", "secondary_two", "shard_one", "shard_two", "shard_three", "championId", "platform", "patch", "role", "elo"]
...
class ItemBuildStat(models.Model):
    ...
    class Meta:
        unique_together = ["legendary_one", "legendary_two", "legendary_three", "legendary_four", "legendary_five", "legendary_six", "championId", "platform", "patch", "role", "elo"]
        db_table = "wrs_api_runepagestat"
        managed = False
...
class SummonerSpellStat(models.Model):
    ...
    class Meta:
        unique_together = ["spell_one", "spell_two", "role", "elo", "championId", "platform", "patch"]
...
# # Generated by Django 4.2.7 on 2024-04-30 20:11
...
#             name='SummonerSpell',
#             fields=[
#                 ('spellId', models.IntegerField(primary_key=True, serialize=False)),
#                 ('name', models.CharField(max_length=20)),
#             ],
#         ),
#         migrations.CreateModel(
...
#         ),
        ...
        #         CREATE INDEX wrs_api_tiertwobootstat_championId ON wrs_api_tiertwobootstat ("championId");
        #         CREATE INDEX wrs_api_tiertwobootstat_spell_one ON wrs_api_summonerspell ("spellId");
        #         CREATE INDEX wrs_api_tiertwobootstat_spell_two ON wrs_api_summonerspell ("spellId");
        #         CREATE INDEX wrs_api_tiertwobootstat_patch ON wrs_api_tiertwobootstat ("patch");
        #         CREATE INDEX wrs_api_tiertwobootstat_patch_like ON wrs_api_tiertwobootstat ("patch" varchar_pattern_ops);
        #         CREATE INDEX wrs_api_tiertwobootstat_platform ON wrs_api_tiertwobootstat ("platform");
        #         CREATE INDEX wrs_api_tiertwobootstat_season_id ON wrs_api_tiertwobootstat ("season_id");
...
#     ]
        ...
        #         CREATE INDEX wrs_api_summonerspellstat_spell_one ON wrs_api_summonerspellstat ("spellId");
        #         CREATE INDEX wrs_api_summonerspellstat_spell_two ON wrs_api_summonerspellstat ("spellId");
