...
class SummonerOverview(models.Model):
    ...
    # Got rid of summoner = models.ForeignKey...to_field="puuid" since technically it is not a PK to Django, but it is part of a composite PK in PSQL
...
class MatchSummoner(models.Model):
    matchId = models.ForeignKey(Match, on_delete=models.CASCADE)
    puuid = models.ForeignKey(Match, on_delete=models.CASCADE, related_name="summoners")
    platform = models.ForeignKey(Platform, on_delete=models.CASCADE, db_column="platform", to_field="code")
...
# # Generated by Django 4.2.7 on 2024-03-29 20:18
