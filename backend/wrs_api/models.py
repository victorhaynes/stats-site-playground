...
class PreferredRole(models.Model):
    ...
    #                 FOREIGN KEY ("role") REFERENCES wrs_api_role ("name") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
    #                 FOREIGN KEY ("championId") REFERENCES wrs_api_champion ("championId") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
    #                 FOREIGN KEY ("completed_boot") REFERENCES wrs_api_tiertwoboot ("itemId") ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
    #                 FOREIGN KEY ("patch") REFERENCES wrs_api_patch (full_version) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
    #                 FOREIGN KEY ("platform") REFERENCES wrs_api_platform (code) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
    ...
    #             CREATE TABLE wrs_api_completedbootstat_na1 PARTITION OF wrs_api_completedbootstat FOR VALUES IN ('na1');
    #             CREATE TABLE wrs_api_completedbootstat_br1 PARTITION OF wrs_api_completedbootstat FOR VALUES IN ('br1');
    #             CREATE TABLE wrs_api_completedbootstat_euw1 PARTITION OF wrs_api_completedbootstat FOR VALUES IN ('euw1');

    #             CREATE INDEX wrs_api_completedbootstat_championId ON wrs_api_completedbootstat ("championId");
    #             CREATE INDEX wrs_api_completedbootstat_completed_boot ON wrs_api_completedbootstat ("completed_boot");
    #             CREATE INDEX wrs_api_completedbootstat_patch ON wrs_api_completedbootstat ("patch");
    #             CREATE INDEX wrs_api_completedbootstat_patch_like ON wrs_api_completedbootstat ("patch" varchar_pattern_ops);
    #             CREATE INDEX wrs_api_completedbootstat_platform ON wrs_api_completedbootstat ("platform");
    #             CREATE INDEX wrs_api_completedbootstat_season_id ON wrs_api_completedbootstat ("season_id");
    #             CREATE INDEX wrs_api_completedbootstat_role ON wrs_api_completedbootstat ("role");
    #             CREATE INDEX wrs_api_completedbootstat_elo_p9q0r1s2 ON wrs_api_completedbootstat ("elo");
    #             CREATE INDEX wrs_api_completedbootstat_elo_p9q0r1s2_like ON wrs_api_completedbootstat ("elo" varchar_pattern_ops);
    ...
    #                 DROP TABLE wrs_api_completedbootstat_na1 CASCADE;
    #                 DROP TABLE wrs_api_completedbootstat_euw1 CASCADE;
    #                 DROP TABLE wrs_api_completedbootstat_br1 CASCADE;
    #                 DROP TABLE wrs_api_completedbootstat CASCADE;
